      ...
      <div className="bg-gray-200 w-full min-h-screen flex items-center justify-center">
        <div className="w-full py-8">
          ...
          <div className="bg-white w-5/6 md:w-3/4 lg:w-2/3 xl:w-[500px] 2xl:w-[550px] mt-8 mx-auto px-16 py-8 rounded-lg shadow-2xl">
            ...
            <p className="text-center text-sm text-gray-600 mt-2">Don't have an account? <a href="#" className="text-blue-600 hover:text-blue-700 hover:underline" title="Sign In" onClick={() => router.push("/signup")} >Sign Up</a></p>
